...
// Filled (not outline) silhouettes — reads as a cleaner, more polished
// avatar placeholder at small sizes than a thin stroke icon does. Used for
// MALE and as the neutral/OTHER default; FemaleAvatarIcon layers a hair
// silhouette on top of the same base shape.
...
export function FemaleAvatarIcon({ className = "size-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      <path
        d="M12 3.2c-3.3 0-5.8 2.6-5.8 5.9 0 2 .8 4.1 2 5.5.1-1.6.2-3.4.2-3.4s1.3 1 3.6 1 3.6-1 3.6-1 .1 1.8.2 3.4c1.2-1.4 2-3.5 2-5.5 0-3.3-2.5-5.9-5.8-5.9Z"
        fill="currentColor"
      />
      <path d="M4 21c0-4.4 3.6-7 8-7s8 2.6 8 7" fill="currentColor" />
    </svg>
