...
// Deliberately not i18n'd: this renders before LanguageProvider/i18next has
// initialized, so t() would emit the raw key here.
    ...
    <div className="flex min-h-screen flex-1 items-center justify-center bg-jz-blue-950">
      <div className="flex flex-col items-center gap-7">
        <div className="relative flex flex-col items-center justify-center gap-1">
          ...
          <p className="relative text-[10px] text-jz-white-100">Building Careers. Powering GCC</p>
        </div>
