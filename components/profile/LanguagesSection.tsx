...
export default function LanguagesSection({ onCountChange }: LanguagesSectionProps = {}) {
  ...
  return (
    <section id="languages" className="scroll-mt-24 rounded-2xl border border-jz-border bg-jz-blue-900/40 p-6 backdrop-blur-xl shadow-[0_1px_0_rgba(74,222,128,0.12),0_14px_30px_-22px_rgba(0,0,0,0.35)]">
