  ...
  return (
    <section className="bg-jz-blue-950 py-14">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10">
        ...
        <div className="surface-always-dark mt-8 flex flex-col overflow-hidden rounded-2xl border border-jz-grey-400 bg-jz-blue-800 lg:h-[406px] lg:flex-row">
          <div className="relative aspect-[16/10] w-full shrink-0 overflow-hidden lg:aspect-auto lg:h-full lg:w-[45%]">
            <Image
